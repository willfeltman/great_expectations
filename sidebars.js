      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Markdown Sphinx API Docs', type: 'link', href: '/docs/sphinx_markdown_built_api_docs/markdown/index.html' },
            { label: 'API Docs in iframe', type: 'doc', id: 'reference/test_iframe_simple' },
            { label: 'API Docs html in mdx', type: 'doc', id: 'reference/test_html_in_mdx' },
            { label: 'API Docs html in mdx take two', type: 'doc', id: 'reference/test_html_in_mdx_take_two' },
            { label: 'API Docs html in mdx data_context test', type: 'doc', id: 'reference/test_data_context_mdx' },
            {
              type: 'category',
              ...
              items: [
                ...
                { label: '  .write_config_variables_template_to_disk(...)', type: 'doc', id: 'api_docs/methods/testing_add_docusaurus_nav_to_sphinx_data_context_method' }
              ]
            }
          ]
        },
        {
          ...
          label: 'test_api',
          link: { type: 'doc', id: 'reference/api_reference' },
          items: [{ type: 'autogenerated', dirName: 'reference/test_api' }]
        },
        {
          type: 'category',
